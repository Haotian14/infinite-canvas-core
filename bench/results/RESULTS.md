...
Generated 2026-09-16T08:17:41.256Z · 180 measured frames after 30 warmup
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `pan-close` | 100,000 | 584 | 0.20 | 0.40 | 0.50 | 2% ✅ | ±50% |
| `pan-mid` | 100,000 | 5,707 | 1.90 | 2.30 | 2.80 | 14% ✅ | ±11% |
| `zoom-cycle` | 100,000 | 13,922 | 0.80 | 15.70 | 16.60 | 94% ✅ | ±14% |
| `overview` | 100,000 | 97,619 | 13.80 | 15.10 | 16.50 | 91% ✅ | ±17% |
| `overview` *(no LOD)* | 100,000 | 97,619 | 35.20 | 41.90 | 47.40 | 251% ⚠️ | ±7% |
| `overview` *(no LOD, no batching)* | 100,000 | 97,619 | 44.40 | 53.20 | 70.80 | 319% ⚠️ | ±11% |
...
| --- | ---: | ---: | ---: | ---: |
| 10,000 | 107 | 2.6 | 35.0 | **13.5x** |
| 100,000 | 1,027 | 47.5 | 603.8 | **12.7x** |
...
| --- | ---: | ---: | ---: |
| one `fillRect` per node | 44.4 | 53.2 | — |
| + one path per fill colour | 35.2 | 41.9 | 1.26x |
| + sub-pixel LOD | **13.8** | **15.1** | **3.22x** |
